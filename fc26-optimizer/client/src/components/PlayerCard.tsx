...
> = {
  Pace: {
    ...
    bg: "oklch(0.75 0.22 142 / 0.08)",
    border: "oklch(0.75 0.22 142 / 0.25)",
    icon: "⚡",
  },
  Shooting: {
  ...
  Passing: {
    ...
    border: "oklch(0.65 0.20 230 / 0.25)",
    icon: "🔵",
  },
  Dribbling: {
  ...
  "Skill Moves": {
    color: "oklch(0.75 0.22 142)",
    bg: "oklch(0.75 0.22 142 / 0.06)",
    border: "oklch(0.75 0.22 142 / 0.2)",
    icon: "★",
  },
  "Weak Foot": {
    color: "oklch(0.65 0.20 230)",
    bg: "oklch(0.65 0.20 230 / 0.06)",
    border: "oklch(0.65 0.20 230 / 0.2)",
    icon: "◆",
  },
};
  ...
  return (
    <div className="mb-2.5">
      <div className="flex items-center justify-between mb-1">
        <span
          className="text-xs"
          style={{ color: "oklch(0.65 0.01 240)", fontFamily: "'Inter', sans-serif" }}
        >
          {stat.attribute}
        </span>
...
function CategoryBlock({
  ...
  const avg =
    numericStats.length > 0
      ? Math.round(numericStats.reduce((s, r) => s + r.final, 0) / numericStats.length)
      : null;
        ...
        <div className="flex items-center gap-2">
          {avg !== null && (
            <span
              ...
              style={{ color: cfg.color, fontFamily: "'Orbitron', sans-serif" }}
            >
              {avg}
            </span>
          )}
    ...
    >
      <div
        ...
        style={{
          ...
          borderColor: "oklch(0.78 0.18 85 / 0.2)",
        }}
      >
        <div
          className="text-xs tracking-widest uppercase mb-0.5"
          style={{ color: "oklch(0.78 0.18 85)", fontFamily: "'Rajdhani', sans-serif" }}
        >
          Final Player Card
        </div>
        <div
      ...
      {result.playstyles && (
        <div className="px-4 pb-6 mt-2 border-t border-slate-700 pt-4">
          ...
          <div className="flex flex-wrap gap-2">
            ...
            {(!result.playstyles.signatures?.length && !result.playstyles.standard?.length) && (
